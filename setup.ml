...
(* OASIS_START *)
(* DO NOT EDIT (digest: 577071c68760caecc938f8195e33a2a8) *)
(*
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ohll"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "ohll_test.ml"; });
               Executable
                 ({
                     cs_name = "ohll_stdin";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ohll_stdin.ml"; })
            ];
