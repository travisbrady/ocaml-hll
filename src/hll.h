...
/**
 * Merge two HLL's together storing the result in merged_hll
 * @arg hll_a First HLL to merge
 * @arg hll_b Second HLL to merge
 * @arg merged_hll hll structure to store result in
 * @return 0 on success
 */
